const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://www.hynzdc.cn' },
    { title: '博客还在建设中', url: '' }
  ],
  ...
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'SWEETMORE.CN',
  HERO_TITLE_4: '热爱生活',
  HERO_TITLE_5: '小糖豆的Blog',
  HERO_TITLE_LINK: '',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '必看精选', url: '/tag/必看精选' },
  HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HERO_CATEGORY_3: { title: '生活足迹', url: '/tag/生活足迹' },
  ...
  INFO_CARD_URL: 'https://github.com/hynzdc', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_2: '说出你的故事',
  SOCIAL_CARD_TITLE_3: 'Contact Me',
  SOCIAL_CARD_URL: 'https://github.com/hynzdc',
